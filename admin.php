    ...
    <div class="container1">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            <div class="card shadow-sm">
                <img src="pic/person.jpg" class="card-img-top" alt="person">
                <div class="card-body">
                <a img src="pic/arduino.jpg" alt=""></a>
                <p class="card-text">จัดการข้อมูลมาชิกทั้งหมด</p>
            ...
            <div class="col">
            <div class="card shadow-sm">
            <img src="pic/arduino.jpg" class="card-img-top" alt="arduino">
                <div class="card-body">
                <p class="card-text">จัดการข้อมูลอุปกรณ์ทั้งหมด</p>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                    </div>
            ...
            <div class="col">
            <div class="card shadow-sm">
            <img src="pic/borrow.jpg" class="card-img-top" alt="list">
                <div class="card-body">
                <p class="card-text">จัดการรายการยืมอุปกรณ์</p>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                    </div>
