    ...
    <div class="signup">
        ...
        <form action="signup_db.php" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" aria-describedby="email" placeholder="example@example.com">
            </div>
            <div class="mb-3">
            ...
            <button class="w-100 btn btn-lg text-white" style="background-color: #970C10;" type="submit" name="signup">Sign up</button>
        </form>
        <hr>
